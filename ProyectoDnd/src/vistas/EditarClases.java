...
public class EditarClases extends JDialog {
	...
	/**
	 * 
	 * Contructor de la Ventana EditarClases
	 * 
	...
	public class ManejadorBoton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			// Si el origen del evento es comboClasesEditar, se ejecuta
			// cargarClaseSeleccionada
			if (e.getSource() == comboClasesEditar) {
				cargarClaseSeleccionada();
			}
			// Si el origen del evento es comboRazasEditar, se ejecuta
	...
	// Llenar combo clases
	/**
	 * Metodo cargarNombresClases Carga los nombres de la tabla Clases de la
	...
	// Llenar combo razas
	/**
	 * Metodo cargarNombresRazas Carga los nombres de la tabla razas de la
	 * base de datos, y los enlista en un comboBox
	 */
	...
	/**
	 * Metodo cargarClaseSeleccionada Carga los datos de la clase
	 * seleccionado Llena los campos de los componentes correspondientes, con los
	 * datos de clase obtenidos de la base de datos
	 */
	...
	private void cargarClaseSeleccionada() {
		...
		if (nombre != null) {
			...
			if (clase != null) {
				...
				spinnerDaño.setValue(clase.getDadoDano());
			}
		}
	}

	/**
	 * Metodo cargarRazaSeleccionada Carga los datos de la raza
	 * seleccionado Llena los campos de los componentes correspondientes, con los
	 * datos de raza obtenidos de la base de datos
	 */
	private void cargarRazaSeleccionada() {
		...
		if (nombre != null) {
			...
			if (raza != null) {
				...
				comboBoxTamaño.setSelectedItem(raza.getTamanoRaza()); // Selecciona el tamaño de la raza
	...
	private void actualizarClase() {
		try {
			...
			if (clase != null) {
				...
				clase.setDadoDano((int) spinnerDaño.getValue());
	 ...
	 * seleccionada Implementa el metodo del mismo nombre en el controlador
	 * CClase
	 */
	...
	private void actualizarRaza() {
		try {
			...
			if (raza != null) {
				...
				raza.setTamanoRaza((String) comboBoxTamaño.getSelectedItem());
	...
	/**
	 * Metodo buscarClasesConTableModel Muestra los datos de la tabla clases
	 * en pantalla
	 */
	...
	/**
	 * Metodo buscarRazasConTableModel Muestra los datos de la tabla razas
	 * en pantalla
	 */
