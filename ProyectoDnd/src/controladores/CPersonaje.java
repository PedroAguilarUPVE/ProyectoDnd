...
/**
 * Controlador de la entidad Personaje.
 * Gestiona operaciones CRUD y consultas relacionadas con personajes y sus estadísticas.
 */
public class CPersonaje {
    ...
    /**
     * Llena un modelo de tabla con información combinada de personajes, clases, subclases y razas.
     * @param model Modelo de tabla a llenar.
     */
    ...
    public int obtenerIdPersonaje(String nombrePersonaje) {
        ...
        try (Connection conexion = ConexionBDSQLServer.GetConexion();
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al obtener ID del personaje", "Error", JOptionPane.ERROR_MESSAGE);
        }
