...
public class HojaPersonajeV2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HojaPersonajeV2 frame = new HojaPersonajeV2();
	 ...
	 * Create the frame.
	 */
	public HojaPersonajeV2() { // Hoja De Personaje
		...
		Etiquetas = new PlaceHolder(textNombre, "Nombre Del Personaje");
		...
		Etiquetas = new PlaceHolder(textJugador, "Nombre Del Jugador");
		...
		lblTransfondo = new JLabel("Transfondo");
		...
		comboBoxClase.addItem("Barbaro");
		comboBoxClase.addItem("Bardo");
		comboBoxClase.addItem("Druida");
		...
		comboBoxRaza.addItem("Humano");
		comboBoxRaza.addItem("Elfo");
		comboBoxRaza.addItem("Enano");
		comboBoxRaza.addItem("Draconido");
		comboBoxRaza.addItem("Gnomo");
		comboBoxRaza.addItem("Semiorco");
		...
		lblInt = new JLabel("Inteligencia");
		...
		lblCon = new JLabel("Constitucion");
		...
		JLabel lblTiradas = new JLabel("Tiradas De Salvacion");
		...
		rdbtnInterpretacion = new JRadioButton("Interpretacion");
		...
		rdbtnPercepcion = new JRadioButton("Percepcion");
		...
		rdbtnManos = new JRadioButton("Juego Manos");
		...
		rdbtnIntimidacion = new JRadioButton("Intimidacion");
		...
		rdbtnPerspicacia = new JRadioButton("Perspicacia");
		...
		rdbtnPersuacion = new JRadioButton("Persuacion");
		...
		rdbtnTratoAnimal = new JRadioButton("Trato Animal");
		...
		btnCalcular = new JButton("Calcular Modificadores");
		...
		JLabel lblTirarDados = new JLabel("Tirar Dados");
	...
	private class ManejadorBoton implements ActionListener { // Manejador Botones
		...
		public void actionPerformed(ActionEvent EventoBotones) {
	            ...
	            if (textNombre.getText().isEmpty() || textNombre.getText().isBlank()) {
	                ...
	                if (TipoSeleccion == JFileChooser.APPROVE_OPTION) {
	                    ...
	                    try {
	                        ...
	                        Escribir.write(textNombre.getText());
	                        Escribir.close();
	                    } catch (IOException e) {
	                        e.printStackTrace();
			...
			if (EventoBotones.getSource() == btnCalcular) {
			...
			} else if (EventoBotones.getSource() == rdbtnFue || EventoBotones.getSource() == rdbtnDes
				...
				if (!((AbstractButton) EventoBotones.getSource()).isSelected()) {
					 ...
					 * "Solo se pueden escoger 2 competencias", "Error", JOptionPane.ERROR_MESSAGE);
					 */
